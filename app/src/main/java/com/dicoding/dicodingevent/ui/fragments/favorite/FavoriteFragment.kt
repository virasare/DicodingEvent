...
class FavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        favoriteViewModel.events.observe(viewLifecycleOwner) { events ->
        ...
        favoriteViewModel.snackbarText.observe(viewLifecycleOwner) { message ->
            message?.let {
                Snackbar.make(binding.root, it, Snackbar.LENGTH_SHORT).show()
            }
        }

        favoriteViewModel.fetchEvents()
    }
